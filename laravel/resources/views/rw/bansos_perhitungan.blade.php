...
@section('main')
    ...
    <main class="table" id="customers_table">
        ...
        <div class ="input-box-1">
            <span class="details3">Penentuan Nilai Variasi Preferensi</span>  
        </div>
        ...
        <div class ="input-box-1">
            <span class="details3">Penentuan Deviasi Nilai Preferensi</span>  
        </div>
        <section class="table__body">
            <table>
                <thead>
        ...
        <div class ="input-box-1">
            <span class="details3">Penentuan Bobot Kriteria</span>  
        </div>
        <section class="table__body">
            <table>
                <thead>
        ...
        <div class ="input-box-1">
            <span class="details3">Penentuan Nilai PSI</span>  
        </div>
        <section class="table__body">
            <table>
                <thead>
